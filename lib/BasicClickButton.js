...
var BasicClickButton = /** @class */ (function (_super) {
    ...
    function BasicClickButton(materials) {
        ...
        _this.addEventListener("added", function (e) {
            if (!_this.stage)
                return;
            e.remove();
            if (_this.stage._mouseOverIntervalID != null)
                return;
     ...
     */
    BasicClickButton.prototype.addLabel = function (x, y, label, font, color, textAlign) {
    ...
    BasicClickButton.prototype.setLabel = function (index, value) {
        ...
        createjs_cache_util_1.CreatejsCacheUtil.cacheText(this._labelField[index], value);
    };
