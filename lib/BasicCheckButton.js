...
var BasicCheckButton = /** @class */ (function (_super) {
  ...
  BasicCheckButton.prototype.selectButton = function (evt) {
    ...
    var buttonEvt = new BasicButtonEvent_1.BasicButtonEvent(
      BasicButtonEvent_1.BasicButtonEventType.SELECTED
    );
  ...
  BasicCheckButton.prototype.deselectButton = function (evt) {
    ...
    var buttonEvt = new BasicButtonEvent_1.BasicButtonEvent(
      BasicButtonEvent_1.BasicButtonEventType.UNSELECTED
    );
    buttonEvt.buttonValue = this.buttonValue;
    this.dispatchEvent(buttonEvt);
  };
